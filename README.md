...
The analyses and aggregate outputs are unchanged. Version 1.0.3 is a presentation-only patch that gives every Figure 1 flow box a common fixed geometry and every connector an equal visible length; it does not change any cohort, estimate, diagnostic, protocol, or statistical-analysis-plan content. Version 1.0.3 is archived at [doi:10.5281/zenodo.21768657](https://doi.org/10.5281/zenodo.21768657), and the Zenodo concept record for all software versions is [doi:10.5281/zenodo.21761953](https://doi.org/10.5281/zenodo.21761953). Version 1.0.2 is archived at [doi:10.5281/zenodo.21766624](https://doi.org/10.5281/zenodo.21766624), version 1.0.1 at [doi:10.5281/zenodo.21762440](https://doi.org/10.5281/zenodo.21762440), and version 1.0.0 at [doi:10.5281/zenodo.21761954](https://doi.org/10.5281/zenodo.21761954). The accompanying manuscript has not yet been accepted or published; the manuscript DOI will be added when available.
...
Use `CITATION.cff` and cite the immutable v1.0.3 record [doi:10.5281/zenodo.21768657](https://doi.org/10.5281/zenodo.21768657). The concept DOI [doi:10.5281/zenodo.21761953](https://doi.org/10.5281/zenodo.21761953) resolves to the latest software version. The manuscript DOI will be added when available.
